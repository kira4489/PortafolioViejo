      ...
      <div className="container">
        ...
        <div className="texto">
          ...
          <p className="description">
            ...
            academia geek con enfasis en React/Node js. Actualmente me desempeño en la area de Ingeniero de Soporte Devops. Soy Tecnologo en gestión de redes de datos y técnico en Desarrollo de Software, me apasiona
